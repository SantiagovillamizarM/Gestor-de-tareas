...
//Una clase publica para la excepcion llamada "UsuarioNoEncontradoException" la cual es de tipo RuntimeException
...
public class UsuarioNoEncontradoException extends RuntimeException {
    //Esto es un constructor y por eso en vez de void lleva el "UsuarioNoEncontradoException" (ES UNA REGLA)
